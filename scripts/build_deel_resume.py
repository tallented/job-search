...
FOLDER = WORKSPACE / "Send To/20260505 - Deel - Head of Engineering FinTech Platform"
DOCX = FOLDER / "Chris Tallent Resume - Deel - Head of Engineering FinTech Platform.docx"
MD = FOLDER / "Chris Tallent Resume - Deel - Head of Engineering FinTech Platform.md"
SOURCE = WORKSPACE / "CANONICAL - Chris Tallent Resume - CTO.docx"


HEADLINE = "Head of Engineering | FinTech Platforms, Payments & Regulated Systems"

SUMMARY = (
    "Engineering executive with 20+ years leading SaaS platforms, fintech modernization, and regulated "
    "systems delivery. Built payment and credit workflows, customer identity controls, audit-ready AWS access "
    "models, API integrations, billing patterns, and governed AI tooling. Operates well where product, finance, "
    "security, and compliance priorities need reliable engineering systems."
)

SKILLS = [
    "Leadership: Head of Engineering / CTO • Org Design • Coaching • Executive Alignment • Product Partnership",
    "FinTech Platforms: Payment / Credit Workflows • Billing Patterns • Regulated Data • Audit Readiness",
    "Architecture & Reliability: API Design • Event-Driven Workflows • CI/CD • Observability • Incident Response",
    "Security & AI: RBAC / IAM • OIDC • ISO 27001 • MCP Access • Governed AI Workflows",
    "Technical: AWS • Java / Spring • TypeScript / Node.js • Python • PostgreSQL / MySQL • Docker / Kubernetes",
]
...
EXPERIENCE = [
    (
        ...
        [
            ...
            "Coordinated multi-team, bi-directional workflows and API integrations across Pitchstone and multiple customer teams, including networking and cybersecurity dependencies.",
    ...
    (
        ...
        [
            ...
            "Partnered with C-suite and product stakeholders on staged finance-workflow changes while protecting PII with encryption and access controls.",
        ],
    ),
    (
    ...
    (
        ...
        "Technical co-founder for a marketplace platform, taking the product from concept to AWS production.",
        [
...
EARLIER_ROLES = [
    "Senior Associate | dunnhumbyUSA: Built C# and Flex-based retail analytics systems; mentored junior developers.",
    "Senior Software Engineer | Fidelity Investments: Built regulated 401k reporting systems.",
]
